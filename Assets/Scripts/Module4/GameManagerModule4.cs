...
public class GameManagerModule4 : MonoBehaviour
{
    public static GameManagerModule4 instance;
    ...
    [SerializeField] public Button rewardPanelNextButton;
    ...
    private void Awake()
    {
        ...
        if (PlayerPrefs.GetInt("leo") == 0)
            GetComponent<Narratives4>().enabled = true;
    ...
    {
        //if (GetComponent<Lesson4_Controller>().enabled)
           // GetComponent<Lesson4_Controller>().Retry();
        //else if (GetComponent<Lesson4_2_Controller>().enabled)
            //GetComponent<Lesson4_2_Controller>().Retry();
        //else if (GetComponent<Lesson4_3_Controller>().enabled)
            //GetComponent<Lesson4_3_Controller>().Retry();
       // else if (GetComponent<Lesson4_4_Controller>().enabled)
           // GetComponent<Lesson4_4_Controller>().Retry();
       // else if (GetComponent<Lesson4_5_Controller>().enabled)
            //GetComponent<Lesson4_5_Controller>().Retry();
    ...
    public void NextBtn()
    {
        if (GetComponent<Narratives4>().enabled)
            GetComponent<Narratives4>().ShowNarratives();
        else if (GetComponent<Lesson4_Controller>().enabled)
            GetComponent<Lesson4_Controller>().TaskFlow_NextBtn();
        else if (GetComponent<Lesson4_2_Controller>().enabled)
            GetComponent<Lesson4_2_Controller>().TaskFlow_NextBtn();
        else if (GetComponent<Lesson4_3_Controller>().enabled)
            GetComponent<Lesson4_3_Controller>().TaskFlow_NextBtn();
        else if (GetComponent<Lesson4_4_Controller>().enabled)
            GetComponent<Lesson4_4_Controller>().TaskFlow_NextBtn();
        else if (GetComponent<Lesson4_5_Controller>().enabled)
            GetComponent<Lesson4_5_Controller>().TaskFlow_NextBtn();
        //else if (GetComponent<Lesson4_2>().enabled)
        //GetComponent<Lesson4_2>().Task4_2NextBtn();
        //else if (GetComponent<Lesson4_3>().enabled)
        // GetComponent<Lesson4_3>().Task4_3NextBtn();
    }
    ...
    {
        if (PlayerPrefs.GetInt("gameprogress") == 28 || PlayerPrefs.GetInt("lives") == -1)
            SceneManager.LoadScene(1);
        else
    ...
    public void RewardPanell()
    {
        ...
        else
        {
            ...
            {
                LevelText.text = "Lesson 4.1 Completed";
                MoneyText.text = "Earned Leo's Trust";
                PointsText.text = "+15";
            }
            if (PlayerPrefs.GetInt("gameprogress") == 24)
            {
                LevelText.text = "Lesson 4.2 Completed";
                MoneyText.text = "$500 gained as a reward from Leo";
                PointsText.text = "+20";
            }
            if (PlayerPrefs.GetInt("gameprogress") == 25)
            {
                LevelText.text = "Lesson 4.3 Completed";
                MoneyText.text = "50% of Leo’s savings as a gift";
                PointsText.text = "+15";
            }
            if (PlayerPrefs.GetInt("gameprogress") == 26)
            {
                LevelText.text = "Lesson 4.4 Completed";
                MoneyText.text = "";
                PointsText.text = "+15";
            }
            if (PlayerPrefs.GetInt("gameprogress") == 27)
            {
                LevelText.text = "Lesson 4.5 Completed";
                MoneyText.text = "Certificate of Savings Expertise";
                PointsText.text = "+30";
            }
    ...
    {
        CurrentLevelText.text = "Task: " + (PlayerPrefs.GetInt("gameprogress") - 22).ToString() + "/5";
        CurrentLevelText.transform.parent.GetChild(0).GetComponent<Image>().fillAmount = (PlayerPrefs.GetInt("gameprogress") - 23) / 5.0f;
    }
